...
export const INDICES_CATEGORIES: MarketCategory[] = [
  {
    id: 'market-cap',
    name: 'Market Cap',
    description: 'Core US market benchmarks',
  ...
  },
  {
    id: 'sectors',
    name: 'Sectors',
    description: 'Key sector rotation plays',
    color: CATEGORY_COLORS.purple,
    symbols: ['SOXX', 'XLK', 'XLF', 'XLE'],
  },
  {
    id: 'risk-gauges',
    name: 'Risk Gauges',
...
export const CRYPTO_CATEGORIES: MarketCategory[] = [
  {
    id: 'blue-chips',
    name: 'Blue Chips',
    description: 'Top market cap L1/L2 chains',
  ...
  },
  {
    id: 'defi-infra',
    name: 'DeFi & Infra',
    description: 'Utility tokens with real usage',
    color: CATEGORY_COLORS.blue,
    symbols: ['UNI/USD', 'AAVE/USD', 'LINK/USD', 'RNDR/USD'],
  },
  {
    id: 'speculative',
    name: 'Speculative',
    description: 'Higher beta plays',
    color: CATEGORY_COLORS.pink,
    symbols: ['DOGE/USD', 'SHIB/USD', 'ARB/USD', 'AVAX/USD'],
  },
];
...
export const ETF_CATEGORIES: MarketCategory[] = [
  {
    id: 'us-core',
    name: 'US Core',
    description: 'Main US equity exposure',
    color: CATEGORY_COLORS.blue,
  ...
  },
  {
    id: 'global-macro',
    name: 'Global Macro',
    description: 'International, commodities, and bonds',
    color: CATEGORY_COLORS.purple,
    symbols: ['EFA', 'EEM', 'GLD', 'TLT'],
  },
  {
    id: 'sectors',
    name: 'Sectors',
    description: 'Sector rotation and real estate',
    color: CATEGORY_COLORS.cyan,
    symbols: ['XLK', 'XLF', 'XLE', 'VNQ'],
  },
  {
    id: 'high-beta',
    name: 'High Beta',
    description: 'Thematic and leveraged plays',
    color: CATEGORY_COLORS.red,
    symbols: ['ARKK', 'TAN', 'TQQQ', 'SQQQ'],
  },
];
