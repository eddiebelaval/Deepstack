...
export function IntelligentBackground() {
    ...
    // Radar state - expanding pings from fixed origin
    ...
    const animate = useCallback(() => {
        ...
        // 4. Update and Draw Radar Pings (expanding, terrain-morphing)
        ...
        radarRef.current.pings.forEach(ping => {
            ...
            // Green candle ring stroke with glow
            ctx.strokeStyle = `rgba(${GREEN_CANDLE.r}, ${GREEN_CANDLE.g}, ${GREEN_CANDLE.b}, ${ping.alpha * 0.7})`;
            ctx.lineWidth = 2.5;
            ctx.shadowColor = `rgba(${GREEN_CANDLE.r}, ${GREEN_CANDLE.g}, ${GREEN_CANDLE.b}, ${ping.alpha * 0.5})`;
            ctx.shadowBlur = 12;
            ctx.stroke();
            ctx.shadowBlur = 0;

            // Subtle fill
            ctx.fillStyle = `rgba(${GREEN_CANDLE.r}, ${GREEN_CANDLE.g}, ${GREEN_CANDLE.b}, ${ping.alpha * 0.03})`;
            ctx.fill();
        });
        ...
        // Glow ring around origin
        ctx.beginPath();
        ctx.arc(radarRef.current.originX, radarRef.current.originY, 8, 0, Math.PI * 2);
        ctx.strokeStyle = `rgba(${GREEN_CANDLE.r}, ${GREEN_CANDLE.g}, ${GREEN_CANDLE.b}, ${pulseAlpha * 0.5})`;
        ctx.lineWidth = 1;
        ctx.stroke();
